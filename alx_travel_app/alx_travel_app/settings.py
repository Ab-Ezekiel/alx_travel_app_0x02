...
CHAPA_CALLBACK_URL = env('CHAPA_CALLBACK_URL', default='http://127.0.0.1:8000/api/listings/payments/verify/')
CHAPA_RETURN_URL = env('CHAPA_RETURN_URL', default='http://127.0.0.1:8000/payment/success/')
